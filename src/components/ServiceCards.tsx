...
const services = [
  {
    ...
    description: "Elite competition, national & international podium finishes",
  ...
  },
  {
    ...
    description: "High-performance coaching & player development systems",
    iconColor: "text-yellow",
    titleColor: "text-yellow",
    borderColor: "border-yellow",
    bgHover: "hover:bg-yellow/10",
  },
  {
    id: "designing" as const,
    icon: Heart,
    title: "DESIGNING CAREER",
    description: "Creative direction, branding & media execution",
