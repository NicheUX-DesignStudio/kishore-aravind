    ...
    >
      <div className="relative px-2 sm:px-4">
        ...
        <div className="relative flex justify-center">
          ...
          {/* SQUASH text - bottom left */}
          <div className="absolute bottom-2 left-0 font-display text-2xl md:text-3xl lg:text-4xl font-bold text-kinetic whitespace-nowrap">
            SQUASH
          </div>

          {/* SPACE text - bottom right */}
          <div className="absolute bottom-2 right-0 font-display text-2xl md:text-3xl lg:text-4xl font-bold text-systematic whitespace-nowrap">
            SPACE
          </div>
        </div>
      </div>
